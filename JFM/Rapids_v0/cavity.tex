...
\end{align}
\begin{align}
	g^{1}_{1,1,2} = -573 + 340\iota;\hspace{0.5em} & g^{1}_{1,3,4} = -1553 - 342\iota; & g^{3}_{1,2,3} =- 829 + 275\iota;\hspace{0.5em} & g^{3}_{3,3,4} = -751 - 6.99\iota, \nonumber
\end{align}
%\begin{subequations}
%	\label{eqn:normal_form}
%	\begin{equation}
...
and one obtains the original system \eqref{eqn:compact_evolution1} that had a co-dimension one bifurcation point. The first term of $g^{3}_{3}$ in equation~\eqref{eqn:normal_form3} becomes $(-0.092 + 10.31\iota)$, which is precisely the $\lambda_{3}$ eigenvalue of the original system. Henceforth the value of $\sigma'=-\sigma_{0}$ is held fixed and it is treated simply as another constant coefficient term. 
